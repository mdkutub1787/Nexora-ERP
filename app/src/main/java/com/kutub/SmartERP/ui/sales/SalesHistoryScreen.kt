            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Box(
                        modifier = Modifier
                            .size(48.dp)
                            .background(com.kutub.smarterp.ui.theme.PrimaryIndigo.copy(alpha = 0.12f), CircleShape),
                        contentAlignment = Alignment.Center
                    ) {
                        Icon(
                            Icons.Default.Receipt,
                            contentDescription = null,
                            tint = com.kutub.smarterp.ui.theme.PrimaryIndigo
                        )
                    }
                ...
                Surface(
                    ...
                    color = com.kutub.smarterp.ui.theme.IncomeGreen.copy(alpha = 0.15f)
                ) {
                    Text(
                        text = "Completed",
                        style = MaterialTheme.typography.labelMedium,
                        fontWeight = FontWeight.Bold,
                        color = com.kutub.smarterp.ui.theme.IncomeGreen,
