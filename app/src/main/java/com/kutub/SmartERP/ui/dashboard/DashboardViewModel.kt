...
class DashboardViewModel @Inject constructor(
    ...
    val userImage: StateFlow<String?> = preferencesManager.userImageFlow.stateIn(
        viewModelScope,
        SharingStarted.WhileSubscribed(5000),
        null
    )
    ...
    val recentSales: StateFlow<List<com.kutub.smarterp.data.model.SaleEntity>> = saleRepository.getAllSales()
