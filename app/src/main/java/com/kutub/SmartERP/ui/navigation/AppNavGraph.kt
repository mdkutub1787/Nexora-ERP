...
import com.kutub.smarterp.ui.auth.LoginScreen
import com.kutub.smarterp.ui.auth.RegisterScreen
import com.kutub.smarterp.ui.auth.SplashScreen
import com.kutub.smarterp.ui.dashboard.DashboardScreen
import com.kutub.smarterp.ui.product.AddEditProductScreen
import com.kutub.smarterp.ui.product.ProductListScreen
import com.kutub.smarterp.ui.profile.ProfileScreen
import com.kutub.smarterp.ui.settings.SettingsScreen
import com.kutub.smarterp.ui.notifications.NotificationScreen
...
fun AppNavGraph(
    ...
    ModalNavigationDrawer(
        ...
        gesturesEnabled = shouldShowBottomBar, // Only enable gestures on main screens
        drawerContent = {
            ModalDrawerSheet {
                ...
                NavigationDrawerItem(
                    ...
                    selected = currentRoute == "notification_route",
                    onClick = { 
                        scope.launch { drawerState.close() }
        ...
        NavHost(
            ...
            composable("pos_route") {
                com.kutub.smarterp.ui.pos.PosScreen(
            ...
            composable("category_list_route") {
                com.kutub.smarterp.ui.category.CategoryListScreen(
                    onNavigateBack = { navController.popBackStack() },
            ...
            composable(
                ...
                com.kutub.smarterp.ui.category.AddEditCategoryScreen(
            ...
            composable("supplier_list_route") {
                com.kutub.smarterp.ui.supplier.SupplierListScreen(
                    onNavigateBack = { navController.popBackStack() },
            ...
            composable(
                ...
                com.kutub.smarterp.ui.supplier.AddEditSupplierScreen(
            ...
            composable("sales_history_route") {
                com.kutub.smarterp.ui.sales.SalesHistoryScreen(
                    onNavigateBack = { navController.popBackStack() },
            ...
            composable(
                ...
                com.kutub.smarterp.ui.sales.SaleDetailScreen(
                    saleId = saleId, onNavigateBack = { navController.popBackStack() })
            }

            composable("reports_route") {
                com.kutub.smarterp.ui.reports.ReportsScreen(
                    onNavigateBack = { navController.popBackStack() })
            }
        }
    }
